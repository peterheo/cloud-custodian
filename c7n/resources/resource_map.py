...
ResourceMap = {
    ...
    "aws.connect-agent-status": "c7n.resources.connect.ConnectAgentStatus",
    "aws.connect-contact-flow": "c7n.resources.connect.ConnectContactFlow",
    "aws.connect-hours-of-operation": "c7n.resources.connect.ConnectHoursOfOperation",
    "aws.connect-instance": "c7n.resources.connect.Connect",
    "aws.connect-phone-number": "c7n.resources.connect.ConnectPhoneNumber",
    "aws.connect-queue": "c7n.resources.connect.ConnectQueue",
    "aws.connect-quick-connect": "c7n.resources.connect.ConnectQuickConnect",
    "aws.connect-routing-profile": "c7n.resources.connect.ConnectRoutingProfile",
    "aws.connect-user": "c7n.resources.connect.ConnectUser",
